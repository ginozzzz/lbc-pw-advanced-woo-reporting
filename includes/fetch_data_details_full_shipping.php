...
// echo $sql;
    ...
    if ($pw_detail_view == "yes") {
        ...
        $columns = array(
            ...
            array('lable' => esc_html__('T-Shirt Size', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            ...
            array('lable' => esc_html__('Billing Phone', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
    ...
    foreach ($this->results as $items) {
        ...
        if ($pw_detail_view == "yes") {
            if (1){
                ...
                //Phone
                $pw_table_value = isset($items->billing_phone) ? $items->billing_phone : '';
                $display_class  = '';
                if ($this->table_cols[$index_cols++]['status'] == 'hide') {
                    $display_class = 'display:none';
                }
