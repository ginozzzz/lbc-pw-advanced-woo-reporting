...
//print_r($ff_columns);
    ...
    if ($pw_detail_view == "yes") {
        ...
        $columns = array(
            ...
            array('lable' => esc_html__('Customer', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => esc_html__('Email', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
            array('lable' => esc_html__('Phone No.', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'show'),
