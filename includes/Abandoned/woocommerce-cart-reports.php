    ...
    function create_custom_tax()
    {
        register_taxonomy(
           ...
           array(
                ...
                'labels' => array(
	                'name' 				=> esc_html__('Cart statuses', 'woocommerce'),
	                'singular_name' 	=> esc_html__('Cart status', 'woocommerce'),
	                'search_items' 		=> esc_html__('Search Cart statuses', 'woocommerce'),
	                'all_items' 		=> esc_html__('All Cart statuses', 'woocommerce'),
	                'parent_item' 		=> esc_html__('Parent Cart status', 'woocommerce'),
	                'parent_item_colon' => esc_html__('Parent Cart status:', 'woocommerce'),
	                'edit_item' 		=> esc_html__('Edit Cart status', 'woocommerce'),
	                'update_item' 		=> esc_html__('Update Cart status', 'woocommerce'),
	                'add_new_item' 		=> esc_html__('Add New Cart status', 'woocommerce'),
	                'new_item_name' 	=> esc_html__('New Cart status Name', 'woocommerce')
                ),
...
function woocommerce_json_search_customers_carts()
{
    ...
    $default = isset($_GET['default']) ? $_GET['default'] : esc_html__('Guest', 'woocommerce');
