...
//print_r($ff_columns);
	...
	if($pw_detail_view=="yes"){
		...
		$columns=array(
			...
			//CUSTOM WORK - 12300
			array('lable'=>esc_html__('First Name',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
			array('lable'=>esc_html__('Last Name',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
			array('lable'=>esc_html__('Tickera Email',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),

			//CUSTOM WORK - 11899
			//COMPATIBLE WITH ORDER DELIVERY PLUGIN
			array('lable'=>esc_html__('Delivery Date',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
			array('lable'=>esc_html__('Shipping Date',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
		...
		foreach($meta as $opt){
			...
			switch($field_type){
				...
				case "tc_radio_field_form_element":
					$_html='<select name="'.$field_html.'" id="'.$field_html.'"><option value="">'.esc_html__('Choose One',__PW_REPORT_WCREPORT_TEXTDOMAIN__).'</option>';
					if($field_content) {
