<?php
	...
	if($file_used=="sql_table")
	{
		...
		,COALESCE((select meta_value from wp_postmeta where meta_key='_billing_city' and post_id=pw_posts.ID),'') AS 'billing_city_code'
		,COALESCE((select meta_value from wp_postmeta where meta_key='_billing_state' and post_id=pw_posts.ID),'') AS 'billing_state_code'
		,COALESCE((select meta_value from wp_postmeta where meta_key='_billing_country' and post_id=pw_posts.ID),'default') AS 'billing_country'
