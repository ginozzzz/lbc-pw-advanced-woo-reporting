...
if($file_used=="sql_table")
{
	...
	$sql_columns .= "
		...
		,pw_tax.meta_value as item_line_tax
...
//		}
    ...
    LEFT JOIN {$wpdb->prefix}woocommerce_order_itemmeta 	as pw_tax 	ON pw_tax.order_item_id		=	pw_woocommerce_order_items.order_item_id
    ";
...
//echo $sql;
    ...
    $columns=array(
        ...
        array('lable'=>esc_html__('state',__PW_REPORT_WCREPORT_TEXTDOMAIN__),'status'=>'show'),
...
//				$product = wc_get_product( $product_id );
            ...
            //Order Tax
            $display_class='';
            $tax_ratt = $this->pw_get_tax_rate_name($items->order_id,'tax');
...
//print_r($tax_ratt);
            ...
            $pw_table_value = $sum_tax_rate/100;
            $pw_table_value = $items->item_line_tax;
